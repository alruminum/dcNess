...
산출 형식은 [`spec-stories-reference.md`](spec-stories-reference.md)를 따른다.
...
명령 예시는 [`spec-delivery-reference.md`](spec-delivery-reference.md)를 따른다. preflight 를 실행했다면 PR 에 `docs/tech-review.md` 와 `docs/tech-review/` 도 포함한다.
