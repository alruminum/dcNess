...
### Step 4 — 분기 (분기 규칙 진본 = [`tech-review-routing.md`](tech-review-routing.md))
...
- 분기 규칙 (결론→다음 / cycle / 중대 차단 / 비대상 / 후속): [`tech-review-routing.md`](tech-review-routing.md) — 본 skill 분기 규칙 SSOT
