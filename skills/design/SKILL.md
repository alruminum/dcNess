...
- **대상 + 읽을 진본**: epic `stories.md`, root/epic `architecture.md`·`adr.md`·`domain-model.md`, 검토 대상 산출물 같은 SSOT 포인터만 둔다. 요구사항·계약·설계 결정을 prompt 에 전문 재기입하지 않는다.
