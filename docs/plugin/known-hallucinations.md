...
본 카탈로그는 정보 제공 — *강제 X*. agent (특히 architect SYSTEM_DESIGN / MODULE_PLAN / LIGHT_PLAN, code-validator) 가 자율 활용.
...
- `agents/architect/system-design.md` (impl 목차 / 의존 모듈 config 키 검토 시)
- `agents/architect/module-plan.md`
- `agents/architect/light-plan.md`
- `agents/code-validator.md` (config schema 검증 시)
