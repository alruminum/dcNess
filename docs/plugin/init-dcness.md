...
- 역할: `alruminum/dcNess/.github/actions/doc-sync@main` 을 호출해 `docs/index.md` 의 epic 표와 `docs/architecture.md` 의 전역 architecture map 이 파생 원본과 byte-level 로 일치하는지 확인한다. `docs/index.md`, `docs/architecture.md`, 또는 유효 epic 이 없는 빈 환경은 no-op PASS 한다.
