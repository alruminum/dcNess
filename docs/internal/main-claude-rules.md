...
dcness SSOT (orchestration / handoff-matrix / loop-procedure / dcness-rules / self-guidelines / 본 문서) 는 위 2개 강제 영역만 정의. 형식 강제 (마커 / status JSON / Flag) 는 `docs/plugin/prose-only-principle.md` 에 의해 폐기 — 본 문서 안에서도 그 어휘는 사용하지 않는다.
