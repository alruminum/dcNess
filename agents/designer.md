...
> SSOT: [`docs/plugin/design.md`](../docs/plugin/design.md) §8 "AI 슬롭 안티패턴" — 7 클리셰 카탈로그 (backdrop-filter:blur / gradient-text / "Powered by AI" 배지 / box-shadow 글로우 / 보라·인디고 / 균일 rounded-2xl / blur-3xl orb). designer 는 본 SSOT 사전 read 의무 (Phase 0 — `docs/design.md` 있으면 Read).
