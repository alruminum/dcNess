...
| 파일 | 소유 에이전트 |
|---|---|
| `docs/bugfix/**`, `docs/impl/**`, `docs/architecture*`, `docs/adr.md`, `docs/sdk.md`, `docs/db-schema.md`, `docs/domain-logic*` | architect |
...
| `docs/prd.md`, `docs/stories.md` | 메인 Claude (`/product-plan`) |
