...
impl task 의 commit/PR 구조 = [`docs/plugin/loop-procedure.md`](../docs/plugin/loop-procedure.md) §3.4 의 3-commit (docs / tests / src). engineer 는 *src commit* 의 working tree 변경물 (`src/**`) 만 남기고 종료. commit/push/PR/머지 모두 메인 영역.
