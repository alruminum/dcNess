...
**도구 호출 가이드**: `Read prd.md` 1번이 기본. §8 기술 의심 시 `docs/sdk.md` 또는 `reference.md` 추가. **Glob/Grep 합계 5회 초과 = 자기 규율 위반 신호** — 멈추고 PRD 만 다시. **WebFetch/WebSearch** — 차원 8 외부 검증 시 의무 (PRD 명시 외부 의존 1개당 공식 문서 1회 fetch).
