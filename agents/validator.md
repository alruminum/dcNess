...
| 모드 | 인풋 마커 | 상세 |
|---|---|---|
| Plan Validation | `@MODE:VALIDATOR:PLAN_VALIDATION` | [상세](validator/plan-validation.md) |
| Code Validation | `@MODE:VALIDATOR:CODE_VALIDATION` | [상세](validator/code-validation.md) |
| Design Validation | `@MODE:VALIDATOR:DESIGN_VALIDATION` | [상세](validator/design-validation.md) |
| Bugfix Validation | `@MODE:VALIDATOR:BUGFIX_VALIDATION` | [상세](validator/bugfix-validation.md) |
| UX Validation | `@MODE:VALIDATOR:UX_VALIDATION` | [상세](validator/ux-validation.md) |
