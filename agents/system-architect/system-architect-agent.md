...
- root `docs/architecture.md` append 여부와 `docs/conventions.md`/`docs/decisions/` 갱신 여부가 명확하다.
...
- Write 허용: `docs/architecture.md`, `docs/conventions.md`, `docs/decisions/**`, `docs/epics/**/architecture.md`, `docs/epics/**/domain-model.md`, 필요한 분리 detail 문서
