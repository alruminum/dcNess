...
- **Contract 정합성** — cross-task 계약을 produce/consume 하면 impl `## Contract` 가 epic architecture.md `## Contract Ledger` 항목과 일치 (owner / producer / consumer / invariant / forbidden). 계약을 바꿨으면 Ledger 갱신 + CONTRACT_AMENDMENT 보고 (또는 "Ledger 변경 없음" 명시).
