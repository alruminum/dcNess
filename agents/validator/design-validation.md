...
- **Placeholder Leak 룰 (DCN-CHG-20260430-18)** — `docs/sdk.md` / `docs/reference.md` / `docs/architecture.md` / impl task 파일들 안에 `[미기록]` / `[미결]` / `M0 이후 구현` / `NotImplementedError` / `# TODO` 등의 placeholder 발견 시:
