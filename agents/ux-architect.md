...
prose 마지막 단락에 *어떤 결과로 끝났는지 (+ 사유)* 자기 언어로 명시. **결론 emit *전* §UX_FLOW self-check 5 카테고리 의무 — FAIL 시 결론 emit X, 재작업 후 재시도.** 모드별 결론 vocabulary (형식 강제 X — 의미만 맞으면 OK):
...
> 결론별 다음 호출(라우팅) 진본은 *skill 맥락별* — `/ux` skill = [`skills/ux/ux-routing.md`](../skills/ux/ux-routing.md) (UX_FLOW_READY → designer), `/architect-loop` = [`skills/architect-loop/architect-loop-routing.md`](../skills/architect-loop/architect-loop-routing.md) (UX_FLOW_READY → system-architect), 그 외 = [`docs/plugin/routing.md`](../docs/plugin/routing.md) §1 (전환 완료 후 폐기 예정).
...
- 라우팅 (skill 맥락별): `/ux` = [`skills/ux/ux-routing.md`](../skills/ux/ux-routing.md) · `/architect-loop` = [`skills/architect-loop/architect-loop-routing.md`](../skills/architect-loop/architect-loop-routing.md) · 그 외 = [`docs/plugin/routing.md`](../docs/plugin/routing.md) §1 / catastrophic: [`docs/plugin/hooks.md`](../docs/plugin/hooks.md) §3.2
