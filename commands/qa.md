...
## Loop
`qa-triage` ([orchestration.md §3.6](../docs/plugin/orchestration.md) / [loop-procedure.md §7.5](../docs/plugin/loop-procedure.md)).
...
## 사전 read (skill 진입 즉시)
`docs/plugin/orchestration.md` §3.6 + §4.6 + `docs/plugin/handoff-matrix.md` read 후 진행.
