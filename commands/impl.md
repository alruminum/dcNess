...
## Loop
`impl-task-loop` ([orchestration.md §2.1 / §4.3](../docs/orchestration.md)).
...
## 사전 read (skill 진입 즉시)
`docs/loop-procedure.md` + `docs/orchestration.md` §4.3 + `docs/handoff-matrix.md` + `docs/issue-lifecycle.md` read 후 진행.
...
## 절차
[`docs/loop-procedure.md`](../docs/loop-procedure.md) §1~§6 + [`docs/orchestration.md`](../docs/orchestration.md) §4.3 (`impl-task-loop` 풀스펙, Step 4.5 stories sync 포함) 따름. UI 감지 시 §4.4 (`impl-ui-design-loop`).
