...
## Loop
`impl-task-loop` ([orchestration.md §2.1](../docs/orchestration.md) / [loop-catalog.md §3](../docs/loop-catalog.md)).
...
task 파일 끝에 `MODULE_PLAN_READY` 마커 박혀있으면 Step 2 (architect:MODULE_PLAN) skip. 상세 = catalog §3 풀스펙.
