...
| 패턴 | 검출 조건 | 정합 룰 |
|---|---|---|
| `ENUM_CLEAN` | step enum 이 expected 매트릭스 정합 + must_fix=False | [loop-procedure 한눈 인덱스](../docs/plugin/loop-procedure.md#한눈-인덱스-loop-진입-ssot) |
...
- [`agents/system-architect.md` 자기 규율](../agents/system-architect.md#자기-규율-한-줄-룰) — PLACEHOLDER_LEAK 룰 출처 (옛 Spike Gate 차단 패턴)
