...
정상 흐름은 본 skill 본문 + 인용된 docs §번호 만으로 진행. *룰 모호 / 분기 발생* 시에만 `docs/plugin/orchestration.md` §4.5 (qa-triage 풀스펙) / `handoff-matrix.md §1.11` (qa 결론 routing) 부분 read (grep + offset/limit). 통째 read 폐기 — 메인 cache_read 기준치 감축.
