...
`docs/plugin/loop-procedure.md` + `docs/plugin/orchestration.md` §3.1.5 + §4.2 + `docs/plugin/handoff-matrix.md` + `docs/plugin/issue-lifecycle.md` + `docs/plugin/git-naming-spec.md` read 후 진행.
