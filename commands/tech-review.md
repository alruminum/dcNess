...
- 시퀀스 / 핸드오프 / 권한: [`docs/plugin/orchestration.md`](../docs/plugin/orchestration.md) §2.2, [`docs/plugin/handoff-matrix.md`](../docs/plugin/handoff-matrix.md) §1.0 (routing 한눈표 — tech-reviewer 행)
