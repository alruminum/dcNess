...
| [`docs/plugin/deliverables-map.md`](docs/plugin/deliverables-map.md) | 외부 활성 프로젝트의 docs 산출물 위치·양식·계층 (root 전역 vs epic 단위, flat↔epic legacy 경계, 시드=산출 양식) SSOT — 산출물 경로/템플릿 수정 시 |
